# Caves-CliffsSimulator
A data package that makes it possible to "generate" all the new biomes of 1.17.
...
Note: the 1.18 world height version works by itself, it doesn't require the official mojang datapack.
